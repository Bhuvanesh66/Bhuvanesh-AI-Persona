...
def _system() -> str:
    ...
    return (
        ...
        "- Step 3: Collect name and email. Ask the caller to spell the email clearly. Then call book_meeting(name, email, datetime_iso).\n"
        "- Pass email exactly as spoken — the backend normalises it automatically.\n"
