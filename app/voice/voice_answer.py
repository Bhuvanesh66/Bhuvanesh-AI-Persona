...
def _system() -> str:
    ...
    return (
        ...
        "GROUNDING:\n"
        "- If a question is about GitHub repositories, README files, code, or commit history, answer from the retrieved corpus first.\n"
        "- If it is not in the profile or retrieval results, say 'I don't have that detail — shall I book a quick call so you can speak with "
        f"{p} directly?'\n\n"
        "AUTHORSHIP:\n"
        ...
        "- If the caller says 'pm' or 'afternoon', ask for an exact hour and timezone before booking.\n"
